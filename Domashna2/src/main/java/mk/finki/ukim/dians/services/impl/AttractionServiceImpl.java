...
public class AttractionServiceImpl implements AttractionService {
    ...
    @Override
    public Optional<Attraction> saveSkopje(String lat, String lon, String name, String description) {
        return attractionRepository.saveSkopje(lat, lon, name, description);
    }
    @Override
    public Optional<Attraction> saveOhrid(String lat, String lon, String name, String description) {
        return attractionRepository.saveOhrid(lat, lon, name, description);
    }
